...
// New seed
////////////////////////////////////////////////////////////////////////////
template <typename TYPE> void CRandom<TYPE>::Seed(TYPE ulSeed) {
	Index1 = 23;
	Index2 = 54;
	fNextGaussian = 0;
...
////////////////////////////////////////////////////////////////////////////
template <typename TYPE> double CRandom<TYPE>::NextDouble() { return double(NewValue() & 0x7fffffff) / double(1U << 31); }

////////////////////////////////////////////////////////////////////////////
// Next N(0,1)
////////////////////////////////////////////////////////////////////////////
template <typename TYPE> double CRandom<TYPE>::NextGaussian() {
	if (fNextGaussian) {
		fNextGaussian = 0;
...
// Exponential law
////////////////////////////////////////////////////////////////////////////
template <typename TYPE> double CRandom<TYPE>::NextExponential() {
	double x;
	do
		x = NextDouble();
	while (x == 0);
...
template <typename TYPE> void CRandom<TYPE>::BinaryWrite(std::ostream &out) const {
...
template <typename TYPE> void CRandom<TYPE>::BinaryRead(std::istream &in) {
