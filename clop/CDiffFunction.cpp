...
/////////////////////////////////////////////////////////////////////////////
double CDiffFunction::SetLineInput(const double vx0[], const double vDir[], double x) {
...
// Line optimization.
/////////////////////////////////////////////////////////////////////////////
double CDiffFunction::LineOpt(const double vx0[], const double vDir[], bool fTrace) {
	...
	double x = tx[1] - 0.5 * (bma * bma * fbmfc - bmc * bmc * fbmfa) / (bma * fbmfc - bmc * fbmfa);
