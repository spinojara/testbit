...
class CDiffFunction // func
{
	...
	explicit CDiffFunction(int Dimensions)
	    : Dimensions(Dimensions), vCholesky(Dimensions * Dimensions), vStep(Dimensions), vGCopy(Dimensions),
	      vxTemp(Dimensions) {}
	...
	double LineOpt(const double vx0[], const double vDir[], bool fTrace = false);
