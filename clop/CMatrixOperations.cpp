...
/////////////////////////////////////////////////////////////////////////////
bool CMatrixOperations::Cholesky(const double *vMatrix, double *vCholesky, int Size) {
...
/////////////////////////////////////////////////////////////////////////////
void CMatrixOperations::Inverse(const double *vMatrix, double *vInverse, int Size) {
	for (int i = 0; i < Size; i++) {
...
/////////////////////////////////////////////////////////////////////////////
void CMatrixOperations::Solve(const double *restrict vMatrix, double *restrict v, int Size) {
	for (int i = 0; i < Size; i++) {
		for (int j = i; --j >= 0;)
...
/////////////////////////////////////////////////////////////////////////////
void CMatrixOperations::Square(const double *restrict vMatrix, double *restrict vSquare, int Size) {
	for (int i = 0; i < Size; i++)
		for (int j = 0; j <= i; j++) {
			int n;
			if (i > j)
...
/////////////////////////////////////////////////////////////////////////////
void CMatrixOperations::Jacobi(double *restrict vMatrix, double *restrict vEigenVectors, int Size) {
	//
...
class CJacobiComparator {
	...
	int Size;
      ...
      public: ////////////////////////////////////////////////////////////////////
	CJacobiComparator(const double *vMatrix, int Size) : vMatrix(vMatrix), Size(Size) {}

	bool operator()(int i, int j) const { return vMatrix[i * (Size + 1)] < vMatrix[j * (Size + 1)]; }
};
