...
// Constructor
/////////////////////////////////////////////////////////////////////////////
CPFQuadratic::CPFQuadratic(int Dimensions) : CParametricFunction(Dimensions, ((Dimensions + 1) * (Dimensions + 2)) / 2) {}

/////////////////////////////////////////////////////////////////////////////
// Compute value
/////////////////////////////////////////////////////////////////////////////
double CPFQuadratic::GetValue(const double *vParam, const double *vx) const {
	int p = 0;
...
/////////////////////////////////////////////////////////////////////////////
bool CPFQuadratic::GetMax(const double *restrict vParam, double *restrict vx) const {
	//
...
// Compute monomials
/////////////////////////////////////////////////////////////////////////////
void CPFQuadratic::GetMonomials(const double *restrict vx, double *restrict vMonomial) const {
	int p = 0;
...
// Gradient
/////////////////////////////////////////////////////////////////////////////
void CPFQuadratic::GetGradient(const double *restrict vParam, const double *restrict vx, double *restrict vG) const {
	int p = 1;
